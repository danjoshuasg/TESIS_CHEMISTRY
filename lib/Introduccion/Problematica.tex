...
Contrario a las anteriores, las celdas orgánicas y las celdas sensibilizadas por tintes (CSPT) son más sostenibles ambientalmente, a causa de la capacidad de degradación de los polímeros que los componen. Además, pueden construirse por módulos y con diversos materiales orgánicos y metal-orgánicos. Por lo tanto, sus costos de fabricación son comercialmente rentables. Si bien las CSPT han sido las primeras en ser investigadas, las celdas orgánicas las han superado en términos de eficiencia debido al descubrimiento de moléculas aceptoras y donadoras de alto rendimiento que generan y transportan carga \cite{li2022recent}. 

Estos descubrimientos fueron guiados por el conocimiento de la relación que hay entre la estructura y las propiedades de las moléculas. Esto permitió tener mejoras desde la etapa de diseño y extracción de información útil en fases experimentales. No obstante, aún hay brechas en el conocimiento de la existencia de tintes que sean capáces de equiparar a sus similares orgánicas. Complementando la anterior idea, existe la probabilidad de encontrar tintes con propiedades de interés fotovoltaico extraídos de la biodiversidad peruana, lugar donde se realizará el presente proyecto.

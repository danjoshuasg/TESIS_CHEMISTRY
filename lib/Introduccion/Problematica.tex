...
Contrario a las anteriores, las celdas orgánicas y las celdas sensibilizadas por tintes (CSPT) son más sostenibles ambientalmente, ya que los polímeros que los componen pueden ser degradados. Además, son construidos por módulos y con diversos materiales orgánicos y metal-orgánicos. Por lo que sus costos de fabricación serían comercialmente rentables. Si bien las CSPT han sido las primeras en ser investigadas, las celdas orgánicas las han superado en términos de eficiencia debido al descubrimiento de moléculas aceptoras y donadoras de alto rendimiento que generan y transportan carga \cite{li2022recent}. Sin embargo, estas moléculas especializadas son menos accesibles que los tintes de las CSPT. Sumado a la brecha de conocimiento de las propiedades fotoactivas de muchos productos naturales, como los existentes en la biodiversidad peruana, el presente proyecto se concentrará en este último tipo de celda. 


 Los CSPT son dispositivos que aprovechan las absorción luminosa de los tintes para generar energía fotovoltaica. Sus arquitecturas se componen de 4 materiales: El semiconductor, el tinte o sensibilizador, el electrolito y los vidrios conductores (Figura \ref{img:CSPT}). Las CSPT modernas derivan de la celda creada por Brian O'Rigan y Michael Gratzel en 1991 \cite{o1991low}. En dicha celda, usaron óxido de estaño dopado con flúor y partículas de platino (Pt-FTO) como vidrio conductor, el cuál soportaba el óxido de titanio \ce{TiO2} nanocristalino dopado a su vez por nanopartículas de complejos triméricos de rutenio(II) bipidirina (Rutenio-bipidirina) como semiconductor y tinte sensibilizante, respectivamente. Para la regeneración del tinte se utilizó yoduro/triyoduro como electrolito redox. El fotovoltaje ($\Delta V$) de celda corresponde al potencial teórico de trabajo útil y puede aproximarse a la diferencia entre el nivel de energía de Fermi del semiconductor bajo iluminación y el potencial de Nernst del par redox del electrolito.
...
%%%%%%%%%%%%%%%%%%%%% ACELERACIÓN DEL DESCUBRIMIENTO DE NUEVOS MATERIALES %%%%%%%%%%%%%%%%%%%%%%%%

Los descubrimientos de moléculas con estructuras altamente especializadas, por ende con propiedades específicas, es posible actualmente gracias a la existencia de una amplio número de modificaciones de rutas de síntesis y procesos de purificación. El camino clásico para conseguir estos avances es a través del enfoque de "ensayo y error"

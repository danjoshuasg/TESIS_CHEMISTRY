...
La  ecuación \ref{eqn:pce} describe la capacidad del dispositivo para mantener el flujo eléctrico de celda generado por fenómenos fotoeléctricos. Esta capacidad se calcula como el producto de la eficiencia de recolección de luz de longitud $\lambda$ ($text{LHE}(\lambda)$) que mide la fracción de fotones incidentes que son absorbidos por el tinte, 

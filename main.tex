...
\begin{document}
    \begin{titlepage}
        ...
        \vspace{1cm}
        {\bfseries\scshape\Large Comparación de modelos de aprendizaje automático químicamente interpretativos en la clasificación de moléculas de colorantes naturales de celdas solares sensibilizadas por tintes basados en relaciones estructura-propiedad \par}
        \vspace{1cm}
